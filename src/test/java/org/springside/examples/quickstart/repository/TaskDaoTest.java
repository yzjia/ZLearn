...
public class TaskDaoTest extends SpringTransactionalTestCase {
	...
	@Autowired
	private SubjectDao taskDao;

	@Test
	public void findTasksByUserId() throws Exception {
		Page<Subject> tasks = taskDao.findByEnterpriseId(2L, new PageRequest(0, 100, Direction.ASC, "id"));
		assertThat(tasks.getContent()).hasSize(5);
		assertThat(tasks.getContent().get(0).getId()).isEqualTo(1);

		tasks = taskDao.findByEnterpriseId(99999L, new PageRequest(0, 100, Direction.ASC, "id"));
