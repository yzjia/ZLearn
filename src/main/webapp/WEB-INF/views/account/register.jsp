		...
		<form id="inputForm" action="${ctx}/register" method="post" role="form">
				...
				<div class="form-group">
					<label for="confirmPassword" class="control-label">公司名称:</label>
						...
						<input type="text" id="enterpriseName" name="enterpriseName" value="${enterprise.name }"
							class="form-control required" />
				</div>
				<div class="form-group">
					<label for="confirmPassword" class="control-label">组织属性:</label>
					
						<select id="orgAttribute" name="orgAttribute" class="form-control required" value="${enterprise.org_attribute }">
							<option>请选择</option>
